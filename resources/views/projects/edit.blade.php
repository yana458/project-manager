<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('projects.show', $project) }}" class="text-center rounded-xl bg-gray-900 px-4 py-2 text-sm text-white">
                Back
            </a>
        </div>
    </x-slot>
            ...
            <div class="bg-white shadow rounded-xl p-6">
                <form method="POST" action="{{ route('projects.update', $project) }}" class="space-y-4">
                    ...
                    <div class="pt-2 flex gap-2">
                        ...
                        <a href="{{ route('projects.show', $project) }}" class="rounded-xl px-4 py-2 text-sm border">
                            Cancel
                        </a>
                    </div>
                </form>
